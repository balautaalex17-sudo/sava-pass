...
import { requestPasswordSetup } from "./actions";
    ...
    <div style={{
      ...
      >
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div>
            <label htmlFor="staff-email" style={{
              display: "block",
              fontSize: 12,
              fontWeight: 700,
              color: "var(--im-fg-3)",
            ...
            <input
              ...
              type="email"
              value={email}
              onChange={e => { setEmail(e.target.value); setPasswordSetupSent(false); }}
              required
              maxLength={254}
              autoComplete="email"
              className="input"
          ...
          {passwordSetupSent && (
            <p role="status" className="anim-fade" style={{ fontSize: 13, color: "#BAE6FD", lineHeight: 1.55, margin: 0, textAlign: "center" }}>
              Dacă există un cont pentru acest email, vei primi un link temporar de resetare.
            </p>
          )}
        </form>
      </div>
